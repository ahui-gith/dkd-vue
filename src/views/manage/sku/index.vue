  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="skuRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="商品价格" prop="price">
          <el-input-number max="999.99" min="0.01" :precision="2" :step="0.5" v-model="form.price"
            placeholder="请输入商品价格，单位分" />&nbsp;&nbsp;&nbsp;元
        </el-form-item>
    ...
    <el-dialog title="数据导入" v-model="excelOpen" width="400px" append-to-body>
      <el-upload ref="uploadRef" class="upload-demo" :action="uploadExcelUrl" :headers="headers"
        ...
        :auto-upload="false">
        <template #trigger>
          <el-button style="margin: 0 50px;" type="primary">选择文件</el-button>
        </template>
